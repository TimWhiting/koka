...
export function $const($default) /* forall<a,b> (default : a) -> ((x : b) -> a) */  {
  return function(___wildcard_x105__6 /* 287 */ ) {
    return $default;
  };
}
...
export function range_fs_fold(start_0, end_0, init, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e a) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(x_1 /* 811 */ ) {
...
export function range_fs_fold_while(start_0, end_0, init_0, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e maybe<a>) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10039_0 /* maybe<948> */ ) {
...
// monadic lift
export function range_fs__mlift_lift_for_1901_10090(action, end, i, wild__) /* forall<e> (action : (int) -> e (), end : int, i : int, wild_ : ()) -> e () */  {
   
  var i_0_10006 = $std_core_types._int_add(i,1);
  return range_fs__lift_for_1901(action, end, i_0_10006);
}
 
 
// lifted local: range/for, rep
export function range_fs__lift_for_1901(action_0, end_0, i_0) /* forall<e> (action : (int) -> e (), end : int, i : int) -> e () */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return range_fs__mlift_lift_for_1901_10090(action_0, end_0, i_0, wild___0);
      });
    }
    else {
...
export function range_fs_for(start, end, action) /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */  {
  return range_fs__lift_for_1901(action, end, start);
}
...
export function $for(n, action) /* forall<e> (n : int, action : (int) -> e ()) -> e () */  {
  ...
  return range_fs__lift_for_1901(action, end_10008, 0);
}
...
export function repeat(n, action) /* forall<e> (n : int, action : () -> e ()) -> e () */  {
  ...
  return range_fs__lift_for_1901(function(i_0 /* int */ ) {
      return action();
    }, end_10013, 0);
}
...
// monadic lift
export function range_fs__mlift_lift_for_while_1902_10091(action, end, i, _y_x10054) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int, maybe<a>) -> e maybe<a> */  {
  if (_y_x10054 === null) {
     
    var i_0_10015 = $std_core_types._int_add(i,1);
    return range_fs__lift_for_while_1902(action, end, i_0_10015);
  }
  else {
...
export function range_fs__lift_for_while_1902(action_0, end_0, i_0) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int) -> e maybe<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
     
    var x_0_10135 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10054_0 /* maybe<1468> */ ) {
        return range_fs__mlift_lift_for_while_1902_10091(action_0, end_0, i_0, _y_x10054_0);
      });
    }
    else {
      if (x_0_10135 === null) {
...
export function range_fs_for_while(start, end, action) /* forall<a,e> (start : int, end : int, action : (int) -> e maybe<a>) -> e maybe<a> */  {
  return range_fs__lift_for_while_1902(action, end, start);
}
...
export function for_while(n, action) /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */  {
  ...
  return range_fs__lift_for_while_1902(action, end_10017, 0);
}
...
export function _default_exn(action) /* forall<e> (action : () -> <exn,console/console|e> ()) -> <console/console|e> () */  {
  return $std_core_exn.exn_fs__handle($std_core_exn._Hnd_exn(0, function(m /* hnd/marker<<console/console|1738>,()> */ , ___wildcard_x654__16 /* hnd/ev<exn> */ , x /* exception */ ) {
        return $std_core_hnd.yield_to_final(m, function(___wildcard_x654__45 /* (hnd/resume-result<1724,()>) -> <console/console|1738> () */ ) {
