...
module Core.FlowAnalysis.Full.DMCFAR2.Primitives where
...
import Type.Type (splitFunScheme, Type (TCon, TApp), TypeCon (..), Effect, extractOrderedEffect, isEffectEmpty, effectEmpty, typeInt)
