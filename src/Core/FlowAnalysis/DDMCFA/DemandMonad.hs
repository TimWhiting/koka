...
module Core.FlowAnalysis.DDMCFA.DemandMonad(
  ...
  DemandState(..), DemandEnv(..), getDemandEnv, withDemandEnv,
  AnalysisEnv(..), getDemandState, setDemandState, updateDemandState,
  -- Context stuff
