            ...
            -> let toLit  = isLiterate
               ...
               (ranges,
                case info of
                 ...
                 NITypeVar kind _ -> signature env toLit isLiterate "kind" qname qname (showKind env kind) $ cspan "type typevar" $ spanEffect kind pcontent
                 NITypeCon kind _ -> signature env toLit isLiterate "kind" qname (mangleTypeName qname) (showKind env kind) $ cspan "type" $ spanEffect kind pcontent
